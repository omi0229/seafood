...
class UploadedFile extends File
{
    ...
    public function __construct(UploadedFileBase $uploadedFile, CKFinder $app)
    {
		...
		$t = $this->CalcDirectorySize('../../../../uploadfiles/');
		$directorySize = sprintf('%.2f', $t / 1024 / 1024);
		if($directorySize >= '2700') {
			//echo "<script>alert('".$directorySize."')</script>";
			//exit;
			throw new InvalidUploadException('directorySizeLimit');
		}
