    ...
    <div id="app" v-cloak>
        ...
        <div class="row mx-0 px-3">
            <div class="mb-3 col-12 col-md-6">
                <components-search v-model:search_text="keywords" name="目錄" @get-count="getCount" @get-data="setKeywords"></components-search>
            </div>
        ...
        <div class="content px-4">
            <div class="row">
                <div class="col-12">
                    <components-table type="Directory" name="目錄" :list="list" :search_text="search_text" @modify="modify" v-model:check="check"></components-table>
                </div>
