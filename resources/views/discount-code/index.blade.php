                ...
                <div class="modal-body px-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex align-items-center s-14">
                            ...
                            <template v-else>
                                <!-- v-if -->
                                <div v-if="info.is_fixed === 1"> 是，優惠代碼為 <span class="text-danger text-bold">${ info.fixed_name }</span></div>
                                <div v-else> 否，隨機產生的優惠代碼為 <span class="text-danger text-bold">${ info.fixed_name }</span> </div>
                            </template>
                        </div>
                    </div>
                    <div class="form-group">
