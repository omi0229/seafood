    ...
    <div id="app" v-cloak>
        <div class="content-header px-4">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">烹飪教學管理</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/">首頁</a></li>
                            <li class="breadcrumb-item active">烹飪教學管理</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="row mx-0 px-3">
            <div class="mb-3 col-12 col-md-6">
                <components-search v-model:search_text="keywords" name="烹飪教學" @get-count="getCount" @get-data="setKeywords"></components-search>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header row mx-0">
                            <h3 class="card-title col-12 col-lg-6 px-0">烹飪教學列表</h3>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tr v-else>
                                    <th class="text-center" colspan="5"><span class="text-danger">無烹飪教學資料</span></th>
                                </tr>
                                </thead>
                                <tbody>
                                <!-- v-for -->
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">
                        <template v-if="mode == 'create'">新增</template><template v-else>編輯</template>烹飪教學
                    </h4>
