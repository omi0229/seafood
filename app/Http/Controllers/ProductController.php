...
class ProductController extends Controller
{
    ...
    {
        $inputs = $request->only('id', 'product_types_id', 'title', 'content', 'keywords', 'description', 'product_front_cover_image_id', 'web_img_name', 'mobile_img_name', 'sales_status', 'show_status');
